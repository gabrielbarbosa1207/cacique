...
let countInit = 1348;
const countEnd = 8973;
const durationInSeconds = 6; // Duration for the countUp
...
const countDownEnd = 2;
const durationInSecondsDown = 15; // Duration for the countDown, you can change this as per requirement
